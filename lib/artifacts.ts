...
export function buildArtifactMarkdown(params: {
  ...
  if (type === "policy") {
    return [
      ...
      "Before any AI-assisted motion, brief, letter, declaration, or other court-facing filing is submitted, the responsible reviewer must ensure that:",
  ...
  if (type === "prefiling") {
    return [
      ...
      "",
      "Prepared for: Filing team / responsible reviewer",
      "Use: Pre-filing verification and exception review",
      "",
      "## Tonight's Decision Rule",
      "Do not keep editing substance until the verification ledger is complete. Any citation, quotation, pincite, or legal proposition that cannot be verified before filing must be corrected, removed, or escalated to the responsible reviewer.",
      "",
      "## Emergency Filing Gate",
      "| Gate | Required action | Owner | Status |",
      "| --- | --- | --- | --- |",
      "| Freeze draft | Save the version being checked before further edits | Responsible reviewer | Pending |",
      ...
      "| Disclosure check | Review court, judge, standing-order, local-rule, and client requirements | Responsible reviewer | Pending |",
      "| Final review | Responsible reviewer reviews unresolved exceptions and final recommendation | Responsible reviewer | Pending |",
      "",
      "## Verification Ledger",
