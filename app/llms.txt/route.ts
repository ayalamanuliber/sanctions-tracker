...
export function GET() {
  const body = [
    ...
    "- Every index-eligible court, judge, jurisdiction, tool, failure-mode, and consequence profile exposes a source-linked /report review packet with the same evidence boundary.",
    "",
