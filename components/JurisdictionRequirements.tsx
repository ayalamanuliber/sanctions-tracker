    ...
    <section id="jurisdiction" className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-block bg-[#111] border border-white/[0.08] px-3 py-1.5 rounded-full text-[11px] font-semibold text-white/50 tracking-wide uppercase mb-6">
            Jurisdiction Lookup
          </div>
        ...
        <div className="relative mb-8" ref={dropdownRef}>
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#111] border border-white/[0.08] rounded-2xl pl-12 pr-4 py-4 text-white placeholder:text-white/30 focus:outline-none focus:border-[#0066FF]/50 focus:ring-1 focus:ring-[#0066FF]/20 transition-all text-base"
            />
            {query && (
              <button
                onClick={() => {
          ...
          {isOpen && filtered.length > 0 && (
            <div className="absolute z-50 w-full mt-2 bg-[#111] border border-white/[0.08] rounded-2xl overflow-hidden shadow-2xl shadow-black/40 max-h-80 overflow-y-auto">
              {filtered.map((j) => (
                <button
                  key={j.id}
          ...
          {isOpen && query && filtered.length === 0 && (
            <div className="absolute z-50 w-full mt-2 bg-[#111] border border-white/[0.08] rounded-2xl overflow-hidden shadow-2xl shadow-black/40 px-5 py-6 text-center">
        ...
        {selected ? (
          ...
          <div className="bg-[#111] border border-white/[0.08] rounded-2xl px-6 py-12 text-center">
        ...
        {/* Bottom CTA */}
        <div className="mt-10 bg-[#111] border border-white/[0.08] rounded-2xl px-6 py-8 text-center">
